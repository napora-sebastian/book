...
const el = {
  ident: $('ident'),
  graphSel: $('graphSel'), newGraph: $('newGraph'), renameGraph: $('renameGraph'), dropGraph: $('dropGraph'),
  addDoc: $('addDoc'), addThread: $('addThread'), tidy: $('tidy'), fit: $('fit'), linkBtn: $('linkBtn'),
  canvas: $('canvas'), world: $('world'), wires: $('wires'), wireLines: $('wireLines'),
  ghostWire: $('ghostWire'), points: $('points'),
  seed: $('seed'), seedDoc: $('seedDoc'), seedThread: $('seedThread'),
  readout: $('readout'), hint: $('hint'), snacks: $('snacks'),
  inspector: $('inspector'), inspGlyph: $('inspGlyph'), inspTitle: $('inspTitle'), inspSub: $('inspSub'),
  inspBranch: $('inspBranch'), inspClose: $('inspClose'),
  sources: $('sources'), inspLog: $('inspLog'),
  composer: $('composer'), cTask: $('cTask'), cModel: $('cModel'), cStage: $('cStage'),
  cInput: $('cInput'), cSend: $('cSend'), cHalt: $('cHalt'),
...
// A deep link straight to one graph: /grimoire-graphs#graph=3
const deepGraph = /^#graph=(\d+)$/.exec(location.hash);
if (deepGraph && graphs.some((g) => g.id === Number(deepGraph[1]))) {
  await openGraph(Number(deepGraph[1]));
}
